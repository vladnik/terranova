...
// @Success 201 {int} models.Cluster
// @Failure 403 body is empty
// @router /clusters [post]
func (c *ClusterController) Post() {
	var v models.Cluster
	json.Unmarshal(c.Ctx.Input.RequestBody, &v)
	if _, err := models.AddCluster(&v); err == nil {
...
func (c *ClusterController) GetOne() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.ParseInt(idStr, 0, 64)
	v, err := models.GetClusterById(id)
	if err != nil {
		c.Data["json"] = err.Error()
	} else {
		c.Data["json"] = v
...
func (c *ClusterController) GetAll() {
	...
	l, err := models.GetAllCluster(query, fields, sortby, order, offset, limit)
	if err != nil {
		c.Data["json"] = err.Error()
	} else {
		c.Data["json"] = l
...
func (c *ClusterController) Put() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.ParseInt(idStr, 0, 64)
	v := models.Cluster{Id: id}
	json.Unmarshal(c.Ctx.Input.RequestBody, &v)
	if err := models.UpdateClusterById(&v); err == nil {
		c.Data["json"] = "OK"
	} else {
		c.Data["json"] = err.Error()
	}
